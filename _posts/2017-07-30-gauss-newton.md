...
image: assets/images/rectlinE2.png
tags: [featured]
author: davidbarber
---
...
{:.text-center img}
![blogpost_canhappen]({{ site.url }}/assets/images/blogpost_canhappen.png "can happen")

whereas the image below depicts the kind of smooth local maxima that cannot happen:

{:.text-center img}
![blogpost_canthappen]({{ site.url }}/assets/images/blogpost_canthappen.png "cannot happen")
...
{:.text-center img}
![rectlinE1]({{ site.url }}/assets/images/rectlinE1.png "rectlin E1")
...
{:.text-center img}
![rectlinE2]({{ site.url }}/assets/images/rectlinE2.png "rectlin E2")
...
{:.text-center img}
![rectlinE12]({{ site.url }}/assets/images/rectlinE12.png "rectlin E12")
